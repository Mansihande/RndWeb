...
const PackageSchema = new Schema({
  ...
  categories: [{ type: String, ref: 'ServiceCategory' }], // Categories associated with the package
  subcategories: [{ type: String, ref: 'ServiceCategory' }], // Subcategories associated with the package
  subSubcategories: [{ type: String, ref: 'ServiceCategory' }], // Sub-subcategories associated with the package
