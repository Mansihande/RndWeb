...
const NewCategoryForm = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            let urls = 'http://localhost:3006/api/product/insertCategory';
            ...
            if (parentCategoryId && !subCategoryId) {
                urls = `http://localhost:3006/api/product/insertSubCategory?categoryId=${parentCategoryId}`;
            } else if (parentCategoryId && subCategoryId) {
                urls = `http://localhost:3006/api/product/insertSubSubCategory?categoryId=${parentCategoryId}&subCategoryId=${subCategoryId}`;
            }
