...
const Companies = () => {
  ...
  <img
    key={index} // Add a key prop for each item
    src={`/api/serviceImages/download/${company.images}`} 
    alt={company.alt}
    className="object-cover rounded-3xl transform transition-transform duration-300 hover:scale-110"
  />
))}
