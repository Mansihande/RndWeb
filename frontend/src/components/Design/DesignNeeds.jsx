...
export default function CraftLeft() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col lg:flex-row 2xl:justify-center gap-10  lg:px-28  w-full">
        {/* Text Content for Large Screens */}


        <div className=" flex-col mt-10 ">
        <div className="flex gap-4 pb-5"><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">website</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">icoms</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">designs</p> </div>
        <div className="flex gap-4 pb-5"><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">website</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">icoms</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">designs</p> </div>
        <div className="flex gap-4 pb-5"><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">website</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">icoms</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">designs</p> </div>
        <div className="flex gap-4 pb-5"><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">website</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">icoms</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">designs</p> </div>
        <div className="flex gap-4 pb-5"><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">website</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">icoms</p><p className="bg-gray-100 px-10 py-1 rounded-3xl font-bold ">designs</p> </div>
