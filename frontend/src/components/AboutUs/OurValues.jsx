...
const OurValues = () => {
  ...
  return (
    <section className="relative bg-[#114038] overflow-hidden">
      ...
      <div className="bg-dark-green py-8 mt-40 mx-4 sm:mx-8 lg:mx-20">
      ...
      <div className="flex flex-col gap-6 md:flex-row items-center mb-40 mx-4 sm:mx-8 lg:mx-20">
        ...
        <div className="w-full md:w-1/2 mt-8 md:mt-0 h-64 md:h-auto">
